...
var toDoItems:[String] = []
    //This var available to the secondViewController since it's outside the FirstViewController class

class FirstViewController: UIViewController, UITableViewDelegate{
    
    //For some reason, setting the constraints of the TableView to -16 Left and 0 Right makes the lines equidistant from the sides
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //NOTE: func tableView does run code inside if array toDoItems is empty (i.e. when user first opens the app, whether or something has been stored). 
            ...
            //(1)      viewDidload at the first load of the app,
    ...
    //Manually type the line below. Don't forget to right click the table on main storyboard and assign 'referencing outlets' to tasksTable
    @IBOutlet var tasksTable: UITableView!
    
    //-------- optional code for learning ---------

    //If you want to refresh the table everytime the table is loaded, make IBOutlet var tasksTable & override func viewWillAppear
